...
| | | |
|---|---|---|
| 📍 | **[doora.to](https://doora.to)** | Memorable addresses for India — handle like `praneeth@home` → ±5 m location via India Post's DIGIPIN. Next.js · TypeScript · Supabase · Vercel. No app, no signup. |
